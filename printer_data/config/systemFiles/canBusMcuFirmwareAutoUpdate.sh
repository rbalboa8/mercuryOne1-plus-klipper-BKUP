...
make KCONFIG_CONFIG=orbiter_O2S_klipper.config menuconfig
make KCONFIG_CONFIG=orbiter_O2S_klipper.config clean
make KCONFIG_CONFIG=orbiter_O2S_klipper.config -j4
read -p "Orbitoer O2S firmware built, please check above for any errors. Press [Enter] to continue flashing, or [Ctrl+C] to abort"
...
read -p "Orbiter O2S firmware flashed, please check above for any errors. Press [Enter] to continue, or [Ctrl+C] to abort"
